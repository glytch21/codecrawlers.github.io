class Virus {
    constructor(name, xpos = 0, ypos = 0, speed, health, maxHealth) {
        this.name = name
        this.xpos = xpos
        this.ypos = ypos
        this.radius = 18
        ...
        this.audio = {
            logicBombAttack: new Audio('../../public/audio/sfx/logicBombAttack.wav'),
        }
    }
    ...
    draw() {
        ...
        c.fillRect(this.xpos - (this.maxHealth / 7), this.ypos - this.radius * 1.5, this.maxHealth / 3, 5)

        c.fillStyle = 'cyan'
        c.fillRect(this.xpos - (this.maxHealth / 7), this.ypos - this.radius * 1.5, this.health / 3, 5)
    }
    ...
    update() {
        ...
        const yDistance = this.centerY - this.ypos
        const xDistance = this.centerX - this.xpos
