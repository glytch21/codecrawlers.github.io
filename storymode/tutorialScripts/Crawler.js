class Crawler {
  constructor(xpos, ypos) {
      ...
      this.image.src = './../public/icons/players.png'
      ...
      this.audio = {
          attack: new Audio('../../public/audio/sfx/firing2.wav'),
          heal: new Audio('../public/audio/sfx/healing.wav'),
          upgrade: new Audio('../public/audio/sfx/upgrade2.wav'),
          enemyDeath: new Audio('../public/audio/sfx/virus-dying.wav')
      }
  ...
  hidePropertiesFromConsole() {
    ...
    Object.defineProperty(this, 'healthBar', { enumerable: false });
  ...
  draw() {
      ...
      // health bar
      c.fillStyle = 'red'
      c.fillRect(this.xpos - this.healthBar.xpos, this.ypos - 25, this.healthBar.size, 5)

      c.fillStyle = 'cyan'
      c.fillRect(this.xpos - this.healthBar.xpos, this.ypos - 25, this.healthBar.size * this.health / this.maxHealth, 5)
              ...
              if (projectile.virus.health <= 0) {    // Looks for the enemy instance to accurately splice
                  ...
                  if (defeatedEnemyIndex !== -1) {    // This part selects the enemy to be spliced within it's own array.
                      ...
                      if (enemyIndexInArray !== -1) {
                          ...
                          this.audio.enemyDeath.volume = 1
                          this.audio.enemyDeath.play()
                          simulationComplete()
                      }
                  }
              }
  ...
  repair() {
      ...
      this.draw()
      if (this.health >= 1 && this.health <= 99) {
          this.frames.elapsed++
          if (this.frames.elapsed % (this.frames.hold / 4) === 0) {
              this.health++
              this.audio.heal.volume = 0.05
              this.audio.heal.play()
          }
      } else {
          return
      }
  ...
  upgrade() {
      ...
      if (!this.upgraded) {
          ...
          this.healthBar.size = 50
          this.healthBar.xpos = 25
          this.maxHealth = 150
          this.health = 150
          this.radius = 150
          this.speed = 10
          ...
          this.upgraded = true
          this.audio.upgrade.play()

          this.image.src = './public/icons/enemies.png'   // to update
      } else {
